...
exports.cleanUpSubCategories =
  exports.cleanUpCategories =
  exports.cleanUpStores =
  exports.cleanUpAuthorizedBrands =
  exports.cleanUpBrandsApplication =
  exports.cleanUpGovernance =
  exports.cleanUpBrands =
  exports["default"] =
  exports.distributorSlice =
    void 0;

var _toolkit = require("@reduxjs/toolkit");

var _useInitialState = _interopRequireDefault(
  require("@hooks/use-initial-state")
);
...
var distributorSlice = (0, _toolkit.createSlice)({
  ...
  extraReducers: function extraReducers(builder) {
    builder
      .addCase(_actDistributor.fetchPrands.pending, function (state, action) {
      ...
      .addCase(
        _actDistributor.getAllBrandsApplication.pending,
      ...
      .addCase(
        _actDistributor.getAllBrandsApplication.fulfilled,
        function (state, action) {
          // state.loadingAddBrand = false;
          // state.error = action.payload;
          // state.loading = false;
      ...
      .addCase(
        _actDistributor.getAtuthorizedBrands.rejected,
        function (state, action) {
          // state.loadingAddBrand = false;
          // state.error = action.payload;
          // state.loading = false;
      ...
      .addCase(
        _actDistributor.getAtuthorizedBrands.pending,
        function (state, action) {
          // state.loadingAddBrand = false;
          // state.error = action.payload;
          // state.loading = false;
      ...
      .addCase(
        _actDistributor.getAtuthorizedBrands.fulfilled,
        function (state, action) {
          // state.loadingAddBrand = false;
          // state.error = action.payload;
          // state.loading = false;
      ...
      .addCase(
        _actDistributor.getAllBrandsApplication.rejected,
        function (state, action) {
          // state.loadingAddBrand = false;
          // state.error = action.payload;
          // state.loading = false;
      ...
      .addCase(
        _actDistributor.fetchGovernance.pending,
        function (state, action) {
          // state.loadingAddBrand = false;
          // state.error = action.payload;
          // state.loading = false;
      ...
      .addCase(
        _actDistributor.fetchGovernance.fulfilled,
        function (state, action) {
          // state.loadingAddBrand = false;
          // state.error = action.payload;
          // state.loading = false;
      ...
      .addCase(
        _actDistributor.fetchGovernance.rejected,
        function (state, action) {
          // state.loadingAddBrand = false;
          // state.error = action.payload;
          // state.loading = false;
      ...
      .addCase(
        _actDistributor.getSubCategory.pending,
        function (state, action) {
          state.loadingSubCategory = true;
        }
      )
      .addCase(
        _actDistributor.getSubCategory.fulfilled,
        function (state, action) {
          console.log(action.payload);
      ...
      .addCase(
        _actDistributor.getSubCategory.rejected,
        function (state, action) {
          state.loadingSubCategory = false;
        }
      )
      ...
      .addCase(
        _actDistributor.getCategories.fulfilled,
        function (state, action) {
          console.log(action.payload);
      ...
      .addCase(
        _actDistributor.getCategories.rejected,
        function (state, action) {
          state.loadingCategories = false;
        }
      )
